...
.. glossary::
    ...
    KookaSuite
      ...
      **KookaIDE** a MicroPython integrated development tool, and **KookaTW** a tool for mirroring / virtualising the **Kookaberry** display and buttons.
    ...
    Python
      ...
      It nonetheless is a very powerful language and is now favoured by educational institutions as a first taught computer language.
